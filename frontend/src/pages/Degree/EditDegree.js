...
export default function EditDegree(){
    ...
    function getDegree() {
        axios.get(`http://127.0.0.1:5000/admin/degrees/${id}`).then(function(response) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://127.0.0.1:5000/admin/degrees/update_degree/${id}`, inputs).then(function(response){
            console.log(response.data);
            navigate('/degrees');
        });
