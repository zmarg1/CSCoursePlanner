...
export default function EditSubject(){
    ...
    function getSubject() {
        axios.get(`http://127.0.0.1:5000/admin/subjects/${id}`).then(function(response) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://127.0.0.1:5000/admin/subjects/update_subject/${id}`, inputs).then(function(response){
            console.log(response.data);
            navigate('/subjects');
        });
